    ...
    <div className="container ptop mt-5">
      <div className="row Maindiv">
        ...
        <div className="card col-md-4 border border-primary w-25 text-justify fdiv text-center">
          ...
          <h1 className="fs-2">₹4,093 – ₹6,599</h1>
          ...
          <ul className="list-unstyled">
            ...
            <li className="d-flex align-items-center mb-2 lifirst">
              ...
              <p className="mb-0">Earn a certificate upon completion</p>
            </li>
          </ul>
        </div>
          ...
          <div className="card seconddiv border border-primary text-center w-100">
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center mt-4">
                <div className="w-100">
                  <span className="fs-2 bold">₹4,928</span> /<span>month</span>
                </div>
              </div>
          ...
          <div className="card mb-3 border border-primary text-center w-100">
            <div className="card-body mt-2">
              ...
              <ul className="list-unstyled">
                ...
                <li className="d-flex align-items-center mb-2 lifirst mt-4">
                  <svg
                    aria-hidden="true"
                    fill="none"
                    height="16"
                  ...
                  <p className="mb-0 w-100">
                    Access to all courses, Specializations, and Professional Certificates
                  </p>
                </li>
              </ul>
            </div>
